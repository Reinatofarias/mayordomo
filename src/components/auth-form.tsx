...
export function AuthForm({mode}:{mode:'login'|'signup'|'recover'|'password'}) {
 ...
 {mode==='signup'&&<label className="consent"><input type="checkbox" name="consent" required/><span>Acepto los <Link href="/terminos">términos</Link> y la <Link href="/privacidad">privacidad</Link>. MAYORDOMO organiza información financiera; mis decisiones me pertenecen.</span></label>}
